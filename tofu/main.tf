...
# ============================================================================
# This resource automatically generates an Ansible inventory file
# to build/inventory.ini whenever you run 'tofu apply'
# ============================================================================

resource "local_file" "ansible_inventory" {
  # Where to save the generated inventory file (changed to build/)
  filename = "${path.module}/../build/inventory.ini"
